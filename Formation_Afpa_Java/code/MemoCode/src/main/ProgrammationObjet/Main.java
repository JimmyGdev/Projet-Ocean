...
public class Main {
    public static void main(String[] args) {
        ...
        //Comparaison chaine de caractères avec fonctions intégré

        String ch1 = "Il fait froid";
        String ch2 = "Il Fait froid";
        if (ch1.equalsIgnoreCase(ch2)){
            System.out.println("true");
        }
        //changer vitesse avec une seconde methode
        voitureDeMichel.changerVitesse(100, true, 50);
    }
}
